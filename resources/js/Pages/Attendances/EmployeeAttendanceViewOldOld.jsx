...
const EmployeeAttendanceView = () => {
    ...
    const getAttendanceStatus = (employee, day) => {
        ...
        const payrollStatus = employee.payroll_status?.toLowerCase() || "none";
        const date = formatDate(day);
                ...
                return {
                    icon: (
                        <a
                            href="#"
                            onClick={() =>
                                handleEditClick(record, employeeId, date)
                            }
        ...
        return {
            icon: (
                <a
                    href="#"
                    onClick={() => handleEditClick(record, employeeId, date)}
                    className="text-success"
                >
                    <FontAwesomeIcon
                        icon={faCheck}
    ...
    const handleCellClick = (record, employeeId, date) => {
        ...
        setModalOpen(true); // Keep this for editing via cell click
    };

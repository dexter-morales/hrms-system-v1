...
const EmployeeAttendanceView = () => {
    ...
    const handleExportSampleTemplate = () => {
        try {
            ...
            // Adjust range to include headers and sample data
            const range = XLSX.utils.decode_range(worksheet["!ref"]);
            range.s.r = 0; // Start from headers
            range.e.r = 2; // End at sample row (headers + 1 row)
    ...
    const formatExcelDate = (value) => {
        ...
        const date = new Date(value); // works for both strings and serials (when passed in raw)
    ...
    const formatExcelTime = (value) => {
        ...
        // If already in HH:mm format or string, try parsing
    ...
    const handleImportSubmit = () => {
        ...
        const padTime = (t) => {
            ...
            // If input is invalid (e.g. non-numeric), default to "00"

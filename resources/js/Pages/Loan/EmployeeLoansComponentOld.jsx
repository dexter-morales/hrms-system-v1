...
import TermsReactSelect from "@/Components/ui/dropdown/TermsReactSelect";
import FlowbiteReactSelect from "@/Components/ui/dropdown/FlowbiteReactSelect";
...
const EmployeeLoansComponent = () => {
    ...
    // Generate terms options based on loan_type
                        ...
                        >
                            ...
                            <div>
                                ...
                                {/* <Combobox value={selectedPerson} onChange={setSelectedPerson}>
                                    ...
                                    />
                                    <ComboboxOptions className="max-h-60 overflow-y-auto mt-1 border rounded bg-white">
                                        {filteredPeople.map((person, idx) => (
                                        <ComboboxOption key={idx} value={person}>
                                            {person}
                                        </ComboboxOption>
                                        ))}
                                    </ComboboxOptions>
                                ...
                                <ReactSelect
                                    id="terms"
                                    value={termsOptions.find(
                                        (option) => option.value === data.terms
                                    )}
                                    onChange={(selectedOption) =>
                                        setData("terms", selectedOption.value)
                                    }

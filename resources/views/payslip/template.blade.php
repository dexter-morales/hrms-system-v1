...
<body>
    <div class="payslip">
        <div class="header">
            ...
            <h6>{{ $company_settings ? ($company_settings->address ?: 'Address here') : 'Address here' }}</h6>
        </div>
                ...
                <tr>
                    <td style="vertical-align: top; border-right: 1px solid #000;">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>BASIC</td>
                                <td class="amount-column">{{ number_format($payroll->base_pay, 2) }}</td>
                            </tr>
                            <tr>
                                <td>OT-ND ({{ $payroll->night_diff_hours + $payroll->overtime_hours }}h)</td>
                                <td class="amount-column">{{ number_format($payroll->overtime_pay + $payroll->night_diff_pay, 2) }}</td>
                            </tr>
                            <tr>
                                <td>Allowance</td>
                            ...
                            <tr>
                                ...
                                <td class="amount-column">{{ number_format($payroll->leave_with_pay, 2) }}</td>
                            </tr>
                            <tr>
                                <td>Weekend Pay</td>
                                <td class="amount-column">{{ number_format($payroll->weekend_pay, 2) }}</td>
                            </tr>
                        </table>
                    </td>
                    <td style="vertical-align: top;">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>LATE/UNDERTIME ({{ $payroll->late_hours + $payroll->undertime_hours }}h)</td>
                                <td class="deduction-column">{{ number_format($payroll->late_deduction + $payroll->undertime_deduction, 2) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="deduction-column">{{ number_format($payroll->loan_deduction, 2) }}</td>
                            </tr>
                            <tr>
                                <td>SSS</td>

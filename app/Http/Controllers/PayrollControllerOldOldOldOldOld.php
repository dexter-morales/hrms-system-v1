...
class PayrollControllerOldOldOldOldOld extends Controller
{
    ...
    public function generate(Request $request)
    {
        ...
        $employees = Employee::with('site')->where('payroll_status', $paySchedule)->get();
        ...
        foreach ($employees as $employee) {
            try {
                ...
                // dump("proratedSss: ", $proratedSss);
                // dump("proratedPhilhealth: ", $proratedPhilhealth);
                // dump("proratedPagibig: ", $proratedPagibig);
                // dump("proratedTax: ", $proratedTax);
                // dump("proratedLateDeduction: ", $proratedLateDeduction);
                // dump("proratedUndertimeDeduction: ", $proratedUndertimeDeduction);
                // dump("absencesDeduction: ", $absencesDeduction);
                // dump("totalDeductions: ", $totalDeductions);
                // dd("                 ");
    ...
    //         if (!$updated) throw new \Exception('Failed to update payroll record');

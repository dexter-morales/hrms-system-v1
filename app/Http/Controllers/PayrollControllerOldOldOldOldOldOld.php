...
class PayrollControllerOldOldOldOldOldOld extends Controller
{
    ...
    public function generate(Request $request)
    {
        ...
        $employees = Employee::with('site', 'employmentType')->where('payroll_status', $paySchedule)->get();
        ...
        foreach ($employees as $employee) {
            try {
                ...
                // dd("employee->employment_type: " . $employee->employmentType->name);
